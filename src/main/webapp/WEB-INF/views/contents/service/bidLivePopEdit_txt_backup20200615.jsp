			...
			<div class="cont">            
				...
				<div class="onepcssgrid-1200">                
					...
					<!-- 경매 시작/마감 & 경매 문구 입력(직원용)-->					
				  	<div ng-if="!custInfo.CUST_NO">
						<button type="button" onClick="location.href='/login'" style="height: 194px;">
							<spring:message code="label.go.bid.loginlog" />
						</button>	
				  	</div>
					<div ng-if="custInfo.CUST_NO != null && custInfo.EMP_GB == 'Y' && (['ynjang', 'yeeun0210', 'hajenuri', 'jbg211'].indexOf(custInfo.LOGIN_ID) > -1)">
