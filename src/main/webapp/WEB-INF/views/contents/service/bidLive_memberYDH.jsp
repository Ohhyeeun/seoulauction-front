...
<head>
	...
	<%	
		response.setHeader("Access-Control-Allow-Origin","http://stream.camtour.net:81");
	%>
	<link rel="stylesheet" href="http://115.68.235.77:81/src/mse/unreal_html5_player_styles_v1.css" />
	<script src="http://115.68.235.77:81/src/mse/unreal_html5_player_script_v2.js" type="text/javascript"></script> 
</head> 
				...
				<div class="onepcssgrid-1200 client_onepcssgrid-1200 clearfix"> 
					...
					<div class="bidlive_5010 client_web_only clearfix">       
						...
						<div class="bidlive_video client_web_only"> 
							...
							<UnrealHTML5VideoPlayer id="live1"></UnrealHTML5VideoPlayer> 

							   <script type="text/javascript">
							       if ("MediaSource" in window && "WebSocket" in window)
								   {
							           RunPlayer("live1", 854, 480, "stream.camtour.net", 5119, false, "salive", "", true, true, 0, "", false);
									   //document.getElementById("live1_Video").muted = true;
									     //<!-- 딜레이 조정 --> 
									   setInterval(function ()
							                {
							                var video = document.getElementById("live1_video");
							           ...
							           document.getElementById("live1").innerHTML = "브라우저가 지원하지 않습니다. 크롬브라우저를 설치해주십시요";
							   </script>
