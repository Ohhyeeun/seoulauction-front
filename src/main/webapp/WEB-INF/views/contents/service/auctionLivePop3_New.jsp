		...
		$scope.offBid_map = {};
	 	...
	 	$scope.loadLiveAuction = function(){
	 	   ...
	 	   common.callActionSet($d, $s, 
	 			   function(){$scope.is_error = true;}, finalRefresh);
		}
                 ...
                 <div class="col7">
                    <div class="last">
                        <div class="web_only" align="center" ng-show="sale.CURR_CD == 'KRW'">
                            <iframe width="710" height="400" src="http://play.globalhost.co.kr/wowza-webrtc-player/sauc.html" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                        </div><!--web_only-->
 
                        <div class="m_only" align="center" ng-show="sale.CURR_CD == 'KRW'">
                            <iframe width="310" height="180" src="http://play.globalhost.co.kr/wowza-webrtc-player/sauc.html" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div><!--m_only-->
