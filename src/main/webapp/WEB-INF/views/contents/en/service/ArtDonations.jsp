				...
				<div class="contents"> 
					...
					<div class="box_gray type01">
						<div class="contact"> 
							...
							<div class="info">   
								<div class="highlight">서울옥션 마케팅팀 <strong>이현지 선임</strong></div> 
								<div class="tel"><strong class="tit">Tel</strong><span>02-2075-4442</span></div>
								<div class="email"><strong class="tit">E-mail</strong><a href="mailto:hjlee@seoulauction.com">hjlee@seoulauction.com</a></div>
							</div>
						</div> 
