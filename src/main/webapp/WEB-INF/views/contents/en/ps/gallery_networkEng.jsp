					...
					<!-- <div class="storage_cont title_area">
						...
						<div class="storage_cont corp storage_cont_marnon">      
							...
							<div class="contents_box_wrap">   
								<p>
									<span class="txt_green"><span class="font-big">S</span>eoul</span> Auction proposes <gallery network> online business with the idea that we should get together at a critical moment. We suggest collaboration with trustworthy partners using Seoul Auction's website, which has a platform and membership.
								</p>  
	                        </div>  
