                                ...
                                <dl style="padding-top:15px; padding-bottom:20px;">  
                                    <div class="btns">   
                                        ...
                                        <span class="btn_style01 dark" ng-if="viewId == 'CURRENT_AUCTION' && sale.SALE_NO == '000'">
                                            <button type="button" ng-if="viewId == 'CURRENT_AUCTION' && sale.SALE_NO == '000'" name="NOTICE" value="NOTICE" align="center" scrolling="no" onClick="window.open('/noticeView?write_no=3396')"; >NOTICE</button>     
                                        </span>     
                                        ...
                                        <!-- e-book 도록 보기  -->       
                                         ...
                                         <span class="btn_style01 dark" ng-if="viewId == 'CURRENT_AUCTION' && sale.SALE_NO == '569'">  
                                            <button type="button" ng-if="viewId == 'CURRENT_AUCTION' && sale.SALE_NO == '569'" name="ARTIST VIEW" value="ARTIST VIEW" align="center" scrolling="no" onClick="window.open('/zerobaseArtist')"; >ARTIST VIEW</button>  
                                        </span> -->   
