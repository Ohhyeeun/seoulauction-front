	...
	<div ng-controller="lotDetailCtl" data-ng-init="loadLotDetail();">
		...
		<div>
			<div class="subpage">
                ...
                <div class="fontxlarge"><img src="/images/icon/print_logo.png" border="0" style="width:150px;" alt="SeoulAuction"></div> 
				...
				<div>
					<div style="margin-top:5px;">
						...
						<div style="line-height:24px;">
							...
							<div>
								<img src="/images/icon/print_footer.jpg" border="0" style="height: auto; width: 100%;">
							</div>                       
						</div>
					</div> 
				</div>
