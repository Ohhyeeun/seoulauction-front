	...
	<div id="footer">  
		...
		<div class="footer_info web_only">      
			<p> 
				...
				따라서 경매 물품에 대한 매매계약은 위탁자와 낙찰자 사이에 성립하며, ㈜서울옥션은 온라인 경매 약관이 정하는 범위 내에서만 책임을 부담합니다.
			</p> 
		</div>   
		<div class="inquiry tooltip web_only" style="padding: 30px; margin: 0 10px;">         
			<a href="/customer/inquiryForm" class="fix" style="color:#CCC; padding:20px 40px 20px 40px; border:solid 5px #666; font-size:18px; font-wieght:800;">1대1 위탁문의</a>
        </div> 
	</div>
</div>
<!-- //footer_wrap -->
